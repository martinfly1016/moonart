...
const CORE_PAGES = [
  ...
  { path: '/kawaii-copy/', label: 'Kawaii copy hub', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/yumekawa/', label: 'Yumekawa copy', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/name-frame/', label: 'Name frame copy', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/divider-line/', label: 'Divider line copy', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/ribbon/', label: 'Ribbon copy', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/ryosangata-otaku/', label: 'Ryosangata otaku copy', locale: 'ja', group: 'kawaii-copy' },
  { path: '/kawaii-copy/food/', label: 'Food kaomoji copy', locale: 'ja', group: 'kawaii-copy' },
